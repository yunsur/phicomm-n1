...
create_sources_list()
{
	...
	if [[ $INSTALL_DOCKER == yes ]]; then
		...
		echo "deb [arch=$ARCH] https://mirrors.tuna.tsinghua.edu.cn/docker-ce/linux/debian $RELEASE stable" > "${basedir}"/etc/apt/sources.list.d/docker.list
